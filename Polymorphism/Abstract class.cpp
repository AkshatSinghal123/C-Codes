...
•Pointer of abstract class can be created•Pointer of abstract class can hold object of derived class
•Abstract classes are used for achieving polymorphism
•Base class can be
•Concrete
•Abstract with some concrete and some pure virtual functions
•All virtual functions Explain using base and derived class
*/
#include<iostream>
using namespace std;
class Base
